...
public interface NextActService {
	...
	Activity createActivity(long id, long facebookId, boolean isNative, String name, String description, String locationName, String locationCity, long startDate, long endDate, double longitude, long latitude, int participantLimit);
